...
const ComposeMail = ({openDialog, setOpenDialog }) => {
	...
	return(
		...
		>
			...
			<RecipientsWrapper>
				<InputBase placeholder="Recipients" onChange={(e) => onValueChange(e)}/>
				<InputBase placeholder="subject" onChange={(e) => onValueChange(e)}/>
			</RecipientsWrapper>
			<TextField
				multiline
				rows={20}
			...
			<Footer>
				...
				<DeleteOutline onClick={(e) => setOpenDialog(false)}/>
			</Footer>
		</Dialog>
	)
};
